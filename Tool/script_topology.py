...
def initialize(controller_name, controller_ip, controller_port, rest_port, topology, size, query_interval, iface, trials, consec_failures,hosts, hosts_to_add, nolinks, links_to_add, ping,proactive_TDT):
    ...
    for j in range(0, trials):
        ...
        net=benchmark.initialize_workload_via_grpc(controller_name, controller_ip, int(controller_port), int(rest_port),get_target(topology,size,'sep'), topology,hosts, hosts_to_add, nolinks, links_to_add, False) 
        ...
        benchmark.terminate_workload_via_grpc()
